			...
			<div class="modal-body">
				...
				<ul class="nav nav-tabs" role="tablist">
					<li role="presentation" class="active">
						<a href="#upload" id="upload-tab" aria-controls="upload" data-toggle="tab" aria-expanded="true" role="tab">{l_upload_img}</a>
					</li>
					<li role="presentation">
						<a href="#uploadurl" id="uploadurl-tab" aria-controls="uploadurl" data-toggle="tab" aria-expanded="false" role="tab">{l_upload_img_url}</a>
					</li>
				</ul>
				...
				<div class="tab-content">
					<div id="upload" class="tab-pane active in" aria-labelledby="upload-tab" role="tabpanel">
						<form name="sn" action="admin.php?mod=images" method="post" enctype="multipart/form-data" class="form-horizontal">
