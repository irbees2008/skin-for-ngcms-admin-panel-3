	...
	<div class="row">
		<div class="col-sm-10 col-sm-offset-1 form-box">
			<div class="f1">
				...
				<fieldset>
					<h4>»звините, но продолжить установку можно только прин€в услови€ лицензионного соглашени€!</h4>
					<div class="f1-buttons">
						<a href="install.php" class="btn btn-previous">&laquo; ¬ернутьс€ к установке</a>
					</div>
				</fieldset>
			</div>
		</div>
